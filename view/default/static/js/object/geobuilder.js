...
(function () {
  ...
  $.extend(PointSetup.prototype, Setup.prototype, {
    ...
    htmlContent: '<div class="point-shape-setup shape-setup"><div><label>Description</label><textarea class="setup-hint" rows="2"></textarea></div><div class="col-row clearfix"><div class="col-3 col"><label>Mark color</label><input type="text" class="setup-icon-color has-color-picker"></div><div class="col-3 col"><label>Shape</label><select class="setup-preset"><option value="islands#icon">Icon</option><option value="islands#dotIcon">Icon with point</option><option value="islands#circleIcon">Circle</option><option value="islands#circleDotIcon">Circle with point</option></select></div></div><div class="mt15"><button class="btn btn-danger btn-xs btn-remove">Delete</button><button class="btn btn-primary btn-sm btn-done">Apply</button></div></div>',
  ...
  $.extend(LineSetup.prototype, Setup.prototype, {
    ...
    htmlContent: '<div class="line-shape-setup shape-setup"><div><label>Description</label><textarea class="setup-hint" rows="2"></textarea></div><div class="col-row clearfix"><div class="col-3 col"><label>Line color</label><input type="text" class="setup-stroke-color has-color-picker"></div><div class="col-3 col"><label>Opacity</label><select class="setup-stroke-opacity"><option value="1">0</option><option value="0.9">10%</option><option value="0.8">20%</option><option value="0.7">30%</option><option value="0.6">40%</option><option value="0.5">50%</option><option value="0.4">60%</option><option value="0.3">70%</option><option value="0.2">80%</option><option value="0.1">90%</option></select></div><div class="col-3 col"><label>Width</label><select class="setup-stroke-width"><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select></div></div><div class="mt15"><button class="btn btn-danger btn-xs btn-remove">Delete</button><button class="btn btn-primary btn-sm btn-done">Apply</button></div></div>',
