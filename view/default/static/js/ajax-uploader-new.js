...
(function () {
  var defaultSettings = {
    ...
    extensions: null,
    mimeTypes: null,
    tooSmall: __('js.ajaxUploader.tooSmall'),
    tooBig: __('js.ajaxUploader.tooBig'),
    wrongExtension: __('js.ajaxUploader.wrongExtension'),
    wrongMimeType: __('js.ajaxUploader.wrongMimeType'),
    onlyImage: false,
    maxHeight: null,
    maxWidth: null,
    minHeight: 1,
    minWidth: 1,
    notImage: __('js.ajaxUploader.notImage'),
    overHeight: __('js.ajaxUploader.overHeight'),
    overWidth: __('js.ajaxUploader.overWidth'),
    underHeight: __('js.ajaxUploader.underHeight'),
    underWidth: __('js.ajaxUploader.underWidth'),
    tooMany: __('js.ajaxUploader.tooMany'),
    alreadyExists: __('js.ajaxUploader.alreadyExists'),
