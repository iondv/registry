...
function Exporter(options) {
  ...
  this.name = options.name; // Backward compatibility with templates in projects

  this.caption = options.caption; // Backward compatibility with templates in projects
